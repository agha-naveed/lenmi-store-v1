                                ...
                                <td>
                                    <Link href={""} title='Lenovo | N21 | 6th Gen | 16GB Storage | 4GB RAM | 11.6″ Display | Rotatable Camera | Playstore Supported | Chromebook Daraz Like New Slightly Used Import American Stock' className='cursor-pointer flex gap-4 py-5 group'>
                                        ...
                                        <span className='w-full'>
                                            <h2 className='font-semibold tracking-[-1px] md:w-[60%] w-full line-clamp-2 my-2 transition-all group-hover:text-orangeClr'>Lenovo | N21 | 6th Gen | 16GB Storage | 4GB RAM | 11.6″ Display | Rotatable Camera | Playstore Supported | Chromebook Daraz Like New Slightly Used Import American Stock</h2>
